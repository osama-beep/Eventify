...
namespace Eventify.Migrations
{
    ...
    [Migration("20250328115849_AggiuntoBigliettiVenduti")]
    partial class AggiuntoBigliettiVenduti
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eventify.Models.Artista", b =>
                {
            ...
            modelBuilder.Entity("Eventify.Models.Biglietto", b =>
                {
            ...
            modelBuilder.Entity("Eventify.Models.Evento", b =>
                {
                    b.Property<int>("EventoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("BigliettiVenduti")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("PrezzoBiglietto")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("Eventify.Models.Biglietto", b =>
                {
                    b.HasOne("Eventify.Models.Evento", "Evento")
                        .WithMany("Biglietti")
            ...
            modelBuilder.Entity("Eventify.Models.Evento", b =>
                {
                    b.HasOne("Eventify.Models.Artista", "Artista")
                        .WithMany("Eventi")
